// components/student/StudentResultPage.tsx
"use client";
...
export default function StudentResultPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const submissionData = getSubmissions().find(sub => sub.id === params.id);
    if (!submissionData) {
    ...
    setIsLoading(false);
  }, [currentUser, getExam, getSubmissions, getPdfSubmissions, params.id, router]);
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            >
              {calculatePercentage(submission.marks || 0, exam.questions.length)}%
            </Badge>
          </div>
        </div>
